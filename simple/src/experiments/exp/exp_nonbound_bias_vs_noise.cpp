...
// TODO: actually implement this script

void ExponentialNonBoundBiasVsNoise::run_experiment_noise(
    pcg32 &rng,
...
void ExponentialNonBoundBiasVsNoise::run_experiment_const(
    pcg32 &rng,
    std::vector<Technique<Float> *> techniques,
    std::string prefix) const
{
...
void ExponentialNonBoundBiasVsNoise::run_experiment_scos(
    pcg32 &rng,
    std::vector<Technique<Float> *> techniques,
    std::string prefix) const
{
...
void ExponentialNonBoundBiasVsNoise::run_experiment_gauss(
    pcg32 &rng,
    std::vector<Technique<Float> *> techniques,
    std::string prefix) const
{
...
void ExponentialNonBoundBiasVsNoise::run() const
{
...
void ExponentialNonBoundBiasVsNoise::run(int test) const
{
    BlanchetBinFast<Float> *blanchet_bin_fast = new BlanchetBinFast<Float>(0.65);
    PCumeExp<Float> *pcume = new PCumeExp<Float>(1.0);
    PCmfExp<Float> *pcmf = new PCmfExp<Float>(1.0);
