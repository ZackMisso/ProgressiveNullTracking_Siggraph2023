...
void ExponentialJansNonBoundPlots::run_experiment_noise(
    pcg32 &rng,
...
void ExponentialJansNonBoundPlots::run_experiment_const(
    pcg32 &rng,
    std::vector<Technique<Float> *> techniques,
    std::string prefix) const
{
...
void ExponentialJansNonBoundPlots::run_experiment_scos(
    pcg32 &rng,
    std::vector<Technique<Float> *> techniques,
    std::string prefix) const
{
...
void ExponentialJansNonBoundPlots::run_experiment_gauss(
    pcg32 &rng,
    std::vector<Technique<Float> *> techniques,
    std::string prefix) const
{
...
void ExponentialJansNonBoundPlots::run() const
{
    ...
    // BlanchetBinMaj<Float> *blanchet_maj = new BlanchetBinMaj<Float>(0.65, 3);
    ...
    IterRatioExp<Float> *rat_iter_2 = new IterRatioExp<Float>(1.0, 0.2);
...
void ExponentialJansNonBoundPlots::run(int test) const
{
    BlanchetBinFast<Float> *blanchet_bin_fast = new BlanchetBinFast<Float>(0.65);
    PCumeExp<Float> *pcume = new PCumeExp<Float>(1.0);
    PCmfExp<Float> *pcmf = new PCmfExp<Float>(1.0);
