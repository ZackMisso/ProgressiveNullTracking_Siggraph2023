...
template <typename T>
struct RayMarchProgVarNonCorExp : Technique<T>
{
    RayMarchProgVarNonCorExp(Float step) : step(step)
    {
        // blah
    }
    ...
    virtual std::string getName() const { return "noncor_ray_prog_var_exp"; }
