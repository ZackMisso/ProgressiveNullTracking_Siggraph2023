...
template <typename T>
struct RayMarchAdaptiveRatStepExp : Technique<T>
{
    RayMarchAdaptiveRatStepExp(Float step) : step(step)
    {
        // blah
    }
    ...
    virtual std::string getName() const { return "ray_adapratstep_exp"; }
