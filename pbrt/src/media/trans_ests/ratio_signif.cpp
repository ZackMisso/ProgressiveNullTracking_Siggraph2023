...
BlanchetCorrelatedResults RatioTracking_Signif::Tr_Blanchet(
...
Spectrum RatioTracking_Signif::Tr_ManualSig(const Ray& ray, Sampler& sampler,
...
Spectrum RatioTracking_Signif::Tr_MutableSig(const Ray& ray, Sampler& sampler,
...
Spectrum RatioTracking_Signif::Tr_Cull(const Ray& ray, Sampler& sampler,
                                       Float tMin, Float tMax, Float maxD,
                                       Float sig_t) const {
    sampler.BeforeTransmittanceSample();
