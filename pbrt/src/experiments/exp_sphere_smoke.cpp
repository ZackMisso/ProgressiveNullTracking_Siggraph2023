#include "exp_sphere_smoke.h"

#if OPENVDB

ExpSphereSmoke_Tests::ExpSphereSmoke_Tests(pbrt::Options options) {
    // int samples = 8192 * 4;
    // int samples = 256;
    // int samples = 1024;
    // int samples = 64;
    ...
    // runEqualSampleRenders("../hypn_results/sphere_smoke/gt", options,
    // transType,
    //                       scatType, gridType, 2.5, samples, 5, 65);
...
void ExpSphereSmoke_Tests::initializeSceneMediumBox(std::string transType,
                                                    std::string scatType,
                                                    std::string name,
                                                    std::string maj,
                                                    Float majorant) {
...
void ExpSphereSmoke_Tests::runEqualSampleRenders(
...
void ExpSphereSmoke_Tests::initializeLightSources() {
    // pbrtAttributeBegin();
