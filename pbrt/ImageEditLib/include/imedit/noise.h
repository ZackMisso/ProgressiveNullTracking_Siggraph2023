...
namespace imedit
{
    ...
    static Float lerp(Float t, Float one, Float two)
    {
    ...
    static Float gradient(int x, int y, int z, Float dx, Float dy, Float dz)
    {
    ...
    static Float pbrtPerlinNoise(Float x, Float y, Float z)
    {
        int xIndex = floor(x);
        int yIndex = floor(y);
        int zIndex = floor(z);
        ...
        Float g001 = gradient(xIndex, yIndex, zip1, dx, dy, dzm1);
    ...
    static Float noise(Float x, Float y, Float z, Float period)
    {
    ...
    static Float turbulence(Float x, Float y, Float z, Float period)
    {
        Float val = 0.0;
        Float scale = period;
